// One-off generator: creates 4 abstract 3D glass images for the Mulerun
// hackathon judging slide (Workflow, Range, Problem, Vision) via fal.ai
// Flux Pro v1.1, downloads them to public/hackathons/mulerun/judging/.
...
const OUT_DIR = path.resolve("public/hackathons/mulerun/judging");
...
const PROMPTS = {
  workflow:
    `four interconnected glass nodes arranged in a flowing horizontal chain, linked by curving translucent ribbons of light, gentle directional motion left to right, sequential pipeline composition, ${STYLE}`,
  range:
    `a radial fan of seven translucent glass blades spreading outward from a central glowing orb, like an open spectrum or peacock display, symmetrical breadth, ${STYLE}`,
  problem:
    `a precise glass dart embedded in the bullseye of a translucent concentric ring target, three nested rings, dart hitting dead center, ${STYLE}`,
  vision:
    `a sleek glass rocket arcing upward and forward, leaving a soft translucent vapor trail of swirling ribbons, ascent composition, ${STYLE}`,
};
