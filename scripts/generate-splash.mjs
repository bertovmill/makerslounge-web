...
const svg = `<svg width="2732" height="2732" viewBox="0 0 2732 2732" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(1110, 1166)">
    <path d="M0 240V0l80 128 80-128v240" stroke="#c2703e" stroke-width="36" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
    <path d="M208 240V0" stroke="#c2703e" stroke-width="36" stroke-linecap="round"/>
    <path d="M208 240h48" stroke="#c2703e" stroke-width="36" stroke-linecap="round"/>
  </g>
</svg>`;
