...
const SLIDE_CONTEXT: Record<string, string> = {
  ...
  "ai-gateway-api-key":
    "Step 1: adding a Vercel AI Gateway API key. Attendees paste tonight's shared AI_GATEWAY_API_KEY into their agent's .env.local; the key is capped at $100 for the room. Links to the Vercel AI Gateway quickstart.",
