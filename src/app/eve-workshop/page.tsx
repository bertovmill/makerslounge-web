...
import { Card, CardContent } from "@/components/eve-workshop/ui/card";
import { CodeBlock } from "@/components/eve-workshop/code-block";
import { CopyLine } from "@/components/eve-workshop/copy-line";
import { SlideNav } from "@/components/eve-workshop/slide-nav";
...
const presenters = [
  {
    ...
    image: "/eve-workshop/images/presenters/matias-gonzalez.png",
    time: "6:30 PM",
  ...
  },
  {
    ...
    role: "AI Agent MCP",
    image: "/eve-workshop/images/presenters/nazar-ponochevnyi.png",
    time: "6:45 PM",
  ...
  },
  {
    name: "Danial Hasan",
    role: "Key principles",
    image: "/eve-workshop/images/presenters/danial-hasan.png",
    time: "7:00 PM",
  ...
  },
  {
    ...
    image: "/eve-workshop/images/presenters/kelly-sun.png",
    time: "7:10 PM",
...
const stayInTouch: {
...
}[] = [
  {
    ...
    qr: "/eve-workshop/images/qr-tmu-cyber-summit.svg",
    Icon: ShieldCheck,
  },
  {
    ...
    qr: "/eve-workshop/images/qr-makerslounge-calendar.svg",
    Icon: CalendarDays,
  },
];
...
export default function Home() {
  return (
    <main className="h-dvh snap-y snap-mandatory overflow-y-auto scroll-smooth [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      ...
      >
        <Image
          src="/eve-workshop/images/makers-lounge-group.jpg"
        ...
        <div className="absolute inset-x-0 top-0 z-20 border-b border-white/15 bg-ink/50 backdrop-blur-md">
          <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-6 px-6 py-4 md:px-10 md:py-5">
            ...
            <div className="flex shrink-0 items-center gap-5">
              ...
              />
              <Image
                src="/eve-workshop/byte_white-logo_s26.png"
                alt="Byte logo"
                width={140}
                height={140}
        ...
        <div className="relative mx-auto grid w-full max-w-6xl items-center gap-10 md:grid-cols-2 md:gap-14">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="overflow-hidden rounded-3xl shadow-2xl shadow-black/40 ring-1 ring-white/15">
              <Image
                src="/eve-workshop/images/berto-katy-in-action.jpg"
          ...
          <div className="text-center">
            ...
            >
              <Image
                src="/eve-workshop/images/slack-invite-qr.svg"
      ...
      >
        ...
        <Image
          src="/eve-workshop/images/logo-blue.svg"
          alt=""
          aria-hidden
          width={246}
          height={258}
      ...
      >
        ...
        <div className="relative mx-auto w-full max-w-3xl text-center">
          ...
          <div className="mt-12">
            <Image
              src="/eve-workshop/images/tmu-byte-logo-black.png"
              alt="TMU Byte"
              width={1600}
              height={568}
      ...
      >
        ...
        <div className="mx-auto flex h-full w-full max-w-4xl flex-col items-center">
          ...
          <Image
            src="/eve-workshop/images/cursor-download-page.png"
          ...
          <div className="my-6 grid w-full max-w-5xl grid-cols-1 gap-8 sm:grid-cols-3">
            <Card className="border-[#e3ecf5]">
              <CardContent className="flex flex-col items-center gap-3 px-6 py-8 text-center">
                <Image
                  src="/eve-workshop/images/claude-logo.png"
                  alt="Claude logo"
                  width={64}
                  height={64}
                  className="h-16 w-16"
            ...
            <Card className="border-[#e3ecf5]">
              <CardContent className="flex flex-col items-center gap-3 px-6 py-8 text-center">
                <Image
                  src="/eve-workshop/images/codex-logo.png"
                  alt="Codex logo"
                  width={64}
                  height={64}
                  className="h-16 w-16"
            ...
            <Card className="border-[#e3ecf5]">
              <CardContent className="flex flex-col items-center gap-3 px-6 py-8 text-center">
                <Image
                  src="/eve-workshop/images/opencode-logo.png"
                  alt="OpenCode logo"
                  width={64}
                  height={64}
      ...
      >
        ...
        <div className="mx-auto flex h-full w-full max-w-4xl flex-col items-center">
          ...
          <Image
            src="/eve-workshop/images/opencode-ask-ui.png"
      ...
      >
        <div className="mx-auto flex h-full w-full max-w-7xl flex-col items-center">
          ...
          >
            <Image
              src="/eve-workshop/images/run-dev-server.png"
        ...
        <div className="mx-auto flex h-full w-full max-w-7xl flex-col items-center justify-center">
          ...
          <div className="my-3 grid w-full grid-cols-1 items-start gap-5 lg:grid-cols-2">
            ...
            <div className="flex flex-col items-center">
              ...
              >
                <Image
                  src="/eve-workshop/images/debug-copy-error.png"
            ...
            <div className="flex flex-col items-center">
              ...
              >
                <Image
                  src="/eve-workshop/images/debug-paste-error.png"
      ...
      >
        <div className="mx-auto flex h-full w-full max-w-6xl flex-col items-center justify-center">
          ...
          >
            <Image
              src="/eve-workshop/images/env-local-api-key.png"
      ...
      >
        <div className="mx-auto flex h-full w-full max-w-4xl flex-col items-center">
          ...
          <Image
            src="/eve-workshop/images/pam-landing.png"
